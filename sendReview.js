...
const getReviewItem = (link, type) => {
    ...
    return `
        ...
        <div style="display: flex;">
            <button style="background-color: green; margin-right: 20px;"><a href="http://52.194.225.132/review${type}.html" style="color: white; text-decoration: none;">Correct</a></button>
            <button style="background-color: red;"><a href="http://52.194.225.132/review${type}.html" style="color: white; text-decoration: none;">Incorrect</a></button>
        </div>
        <br/>
        -----------------------------------
        <br/>
